...
<head>
    ...
    <title>Student Login | Hall Management System</title>
            ...
            <form method="POST" action="{{ route('student.login') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="student_id" class="form-control @error('student_id') is-invalid @enderror" placeholder="Enter student ID" value="{{ old('student_id') }}" required autofocus>
                    </div>
