    ...
    <form method="POST" action="{{ route('student.login') }}" class="space-y-4">
        ...
        <div>
            ...
            <input
                ...
                required
                autofocus
                class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('email') @enderror"
            >
            @error('email')
